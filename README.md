...
**Last Updated:** 2022-08-21 11:22:31
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20383 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 21 Aug 2022 09:48 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17148 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 21 Aug 2022 09:48 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 46635 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2022-08-21T06:01:10.638Z |
...
- Title: EasyList
- Version: 202208210948
- Last Modified: 21 Aug 2022 09:48 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 62736
Comment Lines: 232
Empty Lines: 0
Non-Domain-only Rules Excluded: 39721
Domain-only Rules Excluded (unsupported options): 2340
Domain-only Rules Excluded (exception conflict): 60
Domain-only Rules Output: 20383
```
...
**Conversion Details:**
```
Total Lines Processed: 27746
Comment Lines: 510
Empty Lines: 0
Non-Domain-only Rules Excluded: 9699
Domain-only Rules Excluded (unsupported options): 218
Domain-only Rules Excluded (exception conflict): 171
Domain-only Rules Output: 17148
```
