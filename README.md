...
**Last Updated:** 2020-01-07 10:52:37
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19814 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 07 Jan 2020 08:25 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7329 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 07 Jan 2020 08:25 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 31569 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-01-06 18:10:20 |
...
- Title: EasyList
- Version: 202001070825
- Last Modified: 07 Jan 2020 08:25 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 70215
Comment Lines: 412
Empty Lines: 0
Non-Domain-only Rules Excluded: 47843
Domain-only Rules Excluded (unsupported options): 2088
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 19814
```
...
Comment Lines: 214
Empty Lines: 0
Non-Domain-only Rules Excluded: 9775
...
Domain-only Rules Output: 31569
```
