...
**Last Updated:** 2018-11-05 07:13:29
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16549 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 05 Nov 2018 06:23 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6207 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 05 Nov 2018 06:23 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 24641 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-11-04 14:39:23 |
...
- Title: EasyList
- Version: 201811050623
- Last Modified: 05 Nov 2018 06:23 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 72974
Comment Lines: 409
Empty Lines: 0
Non-Domain-only Rules Excluded: 53806
Domain-only Rules Excluded (unsupported options): 1940
Domain-only Rules Excluded (exception conflict): 270
Domain-only Rules Output: 16549
```
...
Domain-only Rules Output: 24641
```
