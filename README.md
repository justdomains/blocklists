...
**Last Updated:** 2020-11-10 16:40:59
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17406 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 10 Nov 2020 14:39 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7074 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 10 Nov 2020 14:39 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 37857 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-11-10T15:50:50.845Z |
...
- Title: EasyList
- Version: 202011101439
- Last Modified: 10 Nov 2020 14:39 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 60920
Comment Lines: 334
Empty Lines: 0
Non-Domain-only Rules Excluded: 41577
Domain-only Rules Excluded (unsupported options): 1535
Domain-only Rules Excluded (exception conflict): 68
Domain-only Rules Output: 17406
```
...
**Conversion Details:**
```
Total Lines Processed: 18226
Comment Lines: 311
Empty Lines: 0
Non-Domain-only Rules Excluded: 10513
Domain-only Rules Excluded (unsupported options): 207
Domain-only Rules Excluded (exception conflict): 121
Domain-only Rules Output: 7074
```
