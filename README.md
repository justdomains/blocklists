...
**Last Updated:** 2020-06-17 14:13:45
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17910 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 17 Jun 2020 12:37 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6734 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 17 Jun 2020 12:37 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 36104 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-06-17T11:58:13.494Z |
...
- Title: EasyList
- Version: 202006171237
- Last Modified: 17 Jun 2020 12:37 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 68918
Comment Lines: 447
Empty Lines: 0
Non-Domain-only Rules Excluded: 48634
Domain-only Rules Excluded (unsupported options): 1863
Domain-only Rules Excluded (exception conflict): 64
Domain-only Rules Output: 17910
```
...
Comment Lines: 232
Empty Lines: 0
Non-Domain-only Rules Excluded: 10216
Domain-only Rules Excluded (unsupported options): 170
...
Domain-only Rules Output: 36104
```
