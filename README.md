...
**Last Updated:** 2020-08-02 14:39:51
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17254 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 02 Aug 2020 12:00 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6778 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 02 Aug 2020 12:00 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 35995 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-08-01T15:02:49.749Z |
...
- Title: EasyList
- Version: 202008021200
- Last Modified: 02 Aug 2020 12:00 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67367
Comment Lines: 446
Empty Lines: 0
Non-Domain-only Rules Excluded: 47875
Domain-only Rules Excluded (unsupported options): 1728
Domain-only Rules Excluded (exception conflict): 64
Domain-only Rules Output: 17254
```
...
**Conversion Details:**
```
Total Lines Processed: 17707
Comment Lines: 300
Empty Lines: 0
Non-Domain-only Rules Excluded: 10338
Domain-only Rules Excluded (unsupported options): 180
Domain-only Rules Excluded (exception conflict): 111
Domain-only Rules Output: 6778
```
...
- Version: 2.0.10.79
- Last Modified: 2020-08-01T15:02:49.749Z
...
Domain-only Rules Output: 35995
```
