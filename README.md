...
**Last Updated:** 2019-08-10 09:36:35
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20446 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 10 Aug 2019 09:09 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6756 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 10 Aug 2019 09:09 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29290 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-09 16:57:07 |
...
- Title: EasyList
- Version: 201908100909
- Last Modified: 10 Aug 2019 09:09 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73818
Comment Lines: 432
Empty Lines: 0
Non-Domain-only Rules Excluded: 50564
Domain-only Rules Excluded (unsupported options): 2295
Domain-only Rules Excluded (exception conflict): 81
Domain-only Rules Output: 20446
```
...
Domain-only Rules Output: 29290
```
