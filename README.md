...
**Last Updated:** 2019-10-12 10:08:56
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 21283 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 12 Oct 2019 09:52 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6932 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 12 Oct 2019 09:52 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 30517 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-10-11 17:26:30 |
...
- Title: EasyList
- Version: 201910120952
- Last Modified: 12 Oct 2019 09:52 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74146
Comment Lines: 425
Empty Lines: 0
Non-Domain-only Rules Excluded: 50101
Domain-only Rules Excluded (unsupported options): 2279
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 21283
```
...
**Conversion Details:**
```
Total Lines Processed: 17519
Comment Lines: 207
Empty Lines: 0
Non-Domain-only Rules Excluded: 10071
...
Domain-only Rules Output: 30517
```
