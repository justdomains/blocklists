...
**Last Updated:** 2018-08-14 06:28:30
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15469 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 14 Aug 2018 05:23 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6051 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 14 Aug 2018 05:23 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardDNS/blob/master/LICENSE) | 20967 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-08-13 15:35:46 |
...
- Title: EasyList
- Version: 201808140523
- Last Modified: 14 Aug 2018 05:23 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71268
Comment Lines: 393
Empty Lines: 0
Non-Domain-only Rules Excluded: 53240
Domain-only Rules Excluded (unsupported options): 1890
Domain-only Rules Excluded (exception conflict): 276
Domain-only Rules Output: 15469
```
...
Domain-only Rules Output: 20967
```
