...
**Last Updated:** 2019-06-13 09:07:56
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19377 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 13 Jun 2019 08:19 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6635 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 13 Jun 2019 08:19 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27910 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-06-12 16:31:32 |
...
- Title: EasyList
- Version: 201906130819
- Last Modified: 13 Jun 2019 08:19 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75152
Comment Lines: 439
Empty Lines: 0
Non-Domain-only Rules Excluded: 52853
Domain-only Rules Excluded (unsupported options): 2258
Domain-only Rules Excluded (exception conflict): 225
Domain-only Rules Output: 19377
```
...
Domain-only Rules Output: 27910
```
