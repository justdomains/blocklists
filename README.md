...
**Last Updated:** 2019-01-25 07:55:00
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17050 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 25 Jan 2019 06:42 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6442 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 25 Jan 2019 06:42 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 25429 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-01-24 15:23:30 |
...
- Title: EasyList
- Version: 201901250642
- Last Modified: 25 Jan 2019 06:42 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74265
Comment Lines: 437
Empty Lines: 0
Non-Domain-only Rules Excluded: 54463
Domain-only Rules Excluded (unsupported options): 2044
Domain-only Rules Excluded (exception conflict): 271
Domain-only Rules Output: 17050
```
...
Domain-only Rules Output: 25429
```
