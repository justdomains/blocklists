...
**Last Updated:** 2019-06-17 09:10:00
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19448 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 17 Jun 2019 09:01 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6637 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 17 Jun 2019 09:01 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 28028 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-06-16 16:32:06 |
...
- Title: EasyList
- Version: 201906170901
- Last Modified: 17 Jun 2019 09:01 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75091
Comment Lines: 442
Empty Lines: 0
Non-Domain-only Rules Excluded: 52717
Domain-only Rules Excluded (unsupported options): 2261
Domain-only Rules Excluded (exception conflict): 223
Domain-only Rules Output: 19448
```
...
**Conversion Details:**
```
Total Lines Processed: 16839
Comment Lines: 191
Empty Lines: 0
Non-Domain-only Rules Excluded: 9700
...
Domain-only Rules Output: 28028
```
