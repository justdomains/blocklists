...
**Last Updated:** 2019-06-14 09:08:40
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19406 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 14 Jun 2019 08:39 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6634 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 14 Jun 2019 08:39 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27939 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-06-13 16:31:12 |
...
- Title: EasyList
- Version: 201906140839
- Last Modified: 14 Jun 2019 08:39 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75190
Comment Lines: 440
Empty Lines: 0
Non-Domain-only Rules Excluded: 52861
Domain-only Rules Excluded (unsupported options): 2258
Domain-only Rules Excluded (exception conflict): 225
Domain-only Rules Output: 19406
```
...
Comment Lines: 191
Empty Lines: 0
Non-Domain-only Rules Excluded: 9695
...
Domain-only Rules Output: 27939
```
