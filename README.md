...
**Last Updated:** 2018-06-03 05:54:37
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 14509 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 03 Jun 2018 05:39 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 5867 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 03 Jun 2018 05:53 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardDNS/blob/master/LICENSE) | 19405 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-06-02 14:57:12 |
| [NoCoin Filter List](#nocoin-filter-list-domains-only) | [MIT](https://github.com/hoshsadiq/adblock-nocoin-list/blob/master/LICENSE) | 281 | [**Download**](https://justdomains.github.io/blocklists/lists/nocoin-justdomains.txt) | 31 May 2018 |
...
- Title: EasyList
- Version: 201806030539
- Last Modified: 03 Jun 2018 05:39 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 69934
Comment Lines: 388
Empty Lines: 0
Non-Domain-only Rules Excluded: 52896
Domain-only Rules Excluded (unsupported options): 1875
Domain-only Rules Excluded (exception conflict): 266
Domain-only Rules Output: 14509
```
...
- Title: EasyPrivacy
- Version: 201806030553
- Last Modified: 03 Jun 2018 05:53 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 14995
Comment Lines: 187
Empty Lines: 0
Non-Domain-only Rules Excluded: 8653
Domain-only Rules Excluded (unsupported options): 138
Domain-only Rules Excluded (exception conflict): 150
Domain-only Rules Output: 5867
```
