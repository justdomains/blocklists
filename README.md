...
**Last Updated:** 2019-08-11 09:36:38
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20476 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 11 Aug 2019 09:21 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6759 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 11 Aug 2019 09:21 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29300 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-10 16:58:04 |
...
- Title: EasyList
- Version: 201908110921
- Last Modified: 11 Aug 2019 09:21 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73516
Comment Lines: 419
Empty Lines: 0
Non-Domain-only Rules Excluded: 50264
Domain-only Rules Excluded (unsupported options): 2300
Domain-only Rules Excluded (exception conflict): 57
Domain-only Rules Output: 20476
```
...
**Conversion Details:**
```
Total Lines Processed: 17122
Comment Lines: 196
Empty Lines: 0
Non-Domain-only Rules Excluded: 9848
...
Domain-only Rules Output: 29300
```
