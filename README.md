...
**Last Updated:** 2019-06-11 09:06:12
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19337 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 11 Jun 2019 08:49 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6630 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 11 Jun 2019 08:49 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27841 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-06-10 16:31:31 |
...
- Title: EasyList
- Version: 201906110849
- Last Modified: 11 Jun 2019 08:49 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75114
Comment Lines: 440
Empty Lines: 0
Non-Domain-only Rules Excluded: 52854
Domain-only Rules Excluded (unsupported options): 2258
Domain-only Rules Excluded (exception conflict): 225
Domain-only Rules Output: 19337
```
...
Domain-only Rules Output: 27841
```
