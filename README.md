...
**Last Updated:** 2018-02-16 05:01:32
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 11974 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 16 Feb 2018 03:41 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 5451 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 16 Feb 2018 03:41 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardDNS/blob/master/LICENSE) | 17483 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-02-15 13:58:34 |
...
- Title: EasyList
- Version: 201802160341
- Last Modified: 16 Feb 2018 03:41 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67811
Comment Lines: 379
Empty Lines: 0
Non-Domain-only Rules Excluded: 53552
Domain-only Rules Excluded (unsupported options): 1638
Domain-only Rules Excluded (exception conflict): 268
Domain-only Rules Output: 11974
```
...
**Conversion Details:**
```
Total Lines Processed: 14164
Comment Lines: 183
Empty Lines: 0
Non-Domain-only Rules Excluded: 8254
Domain-only Rules Excluded (unsupported options): 127
Domain-only Rules Excluded (exception conflict): 149
Domain-only Rules Output: 5451
```
...
Domain-only Rules Output: 17483
```
