...
**Last Updated:** 2020-12-25 11:30:44
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17963 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 25 Dec 2020 11:05 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7236 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 25 Dec 2020 11:05 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 38775 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-12-25T10:03:18.878Z |
...
- Title: EasyList
- Version: 202012251105
- Last Modified: 25 Dec 2020 11:05 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 60446
Comment Lines: 295
Empty Lines: 0
Non-Domain-only Rules Excluded: 40540
Domain-only Rules Excluded (unsupported options): 1581
Domain-only Rules Excluded (exception conflict): 67
Domain-only Rules Output: 17963
```
...
Domain-only Rules Output: 38775
```
