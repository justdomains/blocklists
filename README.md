...
**Last Updated:** 2020-02-11 11:11:35
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15588 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 11 Feb 2020 11:00 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6556 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 11 Feb 2020 11:08 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 28071 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-02-10 18:26:50 |
...
- Title: EasyList
- Version: 202002111100
- Last Modified: 11 Feb 2020 11:00 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 65909
Comment Lines: 425
Empty Lines: 0
Non-Domain-only Rules Excluded: 47992
Domain-only Rules Excluded (unsupported options): 1845
Domain-only Rules Excluded (exception conflict): 59
Domain-only Rules Output: 15588
```
...
- Title: EasyPrivacy
- Version: 202002111108
- Last Modified: 11 Feb 2020 11:08 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 16841
Comment Lines: 217
Empty Lines: 0
Non-Domain-only Rules Excluded: 9825
Domain-only Rules Excluded (unsupported options): 152
Domain-only Rules Excluded (exception conflict): 91
Domain-only Rules Output: 6556
```
...
Domain-only Rules Output: 28071
```
