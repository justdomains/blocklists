...
**Last Updated:** 2018-09-21 06:46:42
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15990 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 21 Sep 2018 06:15 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6075 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 21 Sep 2018 06:15 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 21579 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-09-20 14:14:35 |
...
- Title: EasyList
- Version: 201809210615
- Last Modified: 21 Sep 2018 06:15 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71400
Comment Lines: 395
Empty Lines: 0
Non-Domain-only Rules Excluded: 52850
Domain-only Rules Excluded (unsupported options): 1904
Domain-only Rules Excluded (exception conflict): 261
Domain-only Rules Output: 15990
```
...
Domain-only Rules Output: 21579
```
