...
**Last Updated:** 2020-04-07 13:20:52
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17083 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 07 Apr 2020 11:48 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6698 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 07 Apr 2020 11:48 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 30324 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-04-06T21:16:08.901Z |
...
- Title: EasyList
- Version: 202004071148
- Last Modified: 07 Apr 2020 11:48 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67766
Comment Lines: 433
Empty Lines: 0
Non-Domain-only Rules Excluded: 48329
...
**Conversion Details:**
```
Total Lines Processed: 17209
Comment Lines: 222
Empty Lines: 0
Non-Domain-only Rules Excluded: 10024
Domain-only Rules Excluded (unsupported options): 167
Domain-only Rules Excluded (exception conflict): 98
Domain-only Rules Output: 6698
```
...
Domain-only Rules Output: 30324
```
