...
**Last Updated:** 2020-06-28 14:19:14
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17601 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 28 Jun 2020 12:52 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6730 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 28 Jun 2020 12:52 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 35889 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-06-27T14:42:25.296Z |
...
- Title: EasyList
- Version: 202006281252
- Last Modified: 28 Jun 2020 12:52 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 68645
Comment Lines: 449
Empty Lines: 0
Non-Domain-only Rules Excluded: 48683
Domain-only Rules Excluded (unsupported options): 1849
Domain-only Rules Excluded (exception conflict): 63
Domain-only Rules Output: 17601
```
...
**Conversion Details:**
```
Total Lines Processed: 17474
Comment Lines: 233
Empty Lines: 0
Non-Domain-only Rules Excluded: 10232
Domain-only Rules Excluded (unsupported options): 172
Domain-only Rules Excluded (exception conflict): 107
Domain-only Rules Output: 6730
```
...
Domain-only Rules Output: 35889
```
