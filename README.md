...
**Last Updated:** 2019-08-09 09:35:40
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20423 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 09 Aug 2019 01:48 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6756 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 09 Aug 2019 01:48 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29278 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-08 16:57:06 |
...
- Title: EasyList
- Version: 201908090148
- Last Modified: 09 Aug 2019 01:48 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74131
Comment Lines: 432
Empty Lines: 0
Non-Domain-only Rules Excluded: 50877
Domain-only Rules Excluded (unsupported options): 2295
Domain-only Rules Excluded (exception conflict): 104
Domain-only Rules Output: 20423
```
...
Domain-only Rules Output: 29278
```
