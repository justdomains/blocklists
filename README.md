...
**Last Updated:** 2019-11-20 10:28:24
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 21816 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 20 Nov 2019 10:21 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7097 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 20 Nov 2019 10:21 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 31364 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-11-19 17:45:23 |
...
- Title: EasyList
- Version: 201911201021
- Last Modified: 20 Nov 2019 10:21 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 72825
Comment Lines: 425
Empty Lines: 0
Non-Domain-only Rules Excluded: 48248
Domain-only Rules Excluded (unsupported options): 2278
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 21816
```
...
**Conversion Details:**
```
Total Lines Processed: 17025
Comment Lines: 209
Empty Lines: 0
Non-Domain-only Rules Excluded: 9490
Domain-only Rules Excluded (unsupported options): 145
Domain-only Rules Excluded (exception conflict): 84
Domain-only Rules Output: 7097
```
...
Domain-only Rules Output: 31364
```
