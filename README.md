...
**Last Updated:** 2020-04-04 13:18:25
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16965 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 04 Apr 2020 11:42 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6691 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 04 Apr 2020 11:42 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 30190 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-04-03T18:52:52.019Z |
...
- Title: EasyList
- Version: 202004041142
- Last Modified: 04 Apr 2020 11:42 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67646
Comment Lines: 433
Empty Lines: 0
Non-Domain-only Rules Excluded: 48326
Domain-only Rules Excluded (unsupported options): 1859
Domain-only Rules Excluded (exception conflict): 63
Domain-only Rules Output: 16965
```
...
**Conversion Details:**
```
Total Lines Processed: 17180
Comment Lines: 223
Empty Lines: 0
Non-Domain-only Rules Excluded: 10005
Domain-only Rules Excluded (unsupported options): 165
Domain-only Rules Excluded (exception conflict): 96
Domain-only Rules Output: 6691
```
...
Domain-only Rules Output: 30190
```
