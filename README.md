...
**Last Updated:** 2019-04-29 08:45:22
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 18848 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 29 Apr 2019 08:25 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6573 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 29 Apr 2019 08:25 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27303 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-04-28 16:10:05 |
...
- Title: EasyList
- Version: 201904290825
- Last Modified: 29 Apr 2019 08:25 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76350
Comment Lines: 443
Empty Lines: 0
Non-Domain-only Rules Excluded: 54664
Domain-only Rules Excluded (unsupported options): 2126
Domain-only Rules Excluded (exception conflict): 269
Domain-only Rules Output: 18848
```
...
Domain-only Rules Output: 27303
```
