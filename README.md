...
**Last Updated:** 2020-08-03 14:40:34
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17194 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 03 Aug 2020 14:34 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6782 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 03 Aug 2020 14:24 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 36009 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-08-02T15:03:26.408Z |
...
- Title: EasyList
- Version: 202008031434
- Last Modified: 03 Aug 2020 14:34 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67217
Comment Lines: 444
Empty Lines: 0
Non-Domain-only Rules Excluded: 47789
Domain-only Rules Excluded (unsupported options): 1726
Domain-only Rules Excluded (exception conflict): 64
Domain-only Rules Output: 17194
```
...
- Title: EasyPrivacy
- Version: 202008031424
- Last Modified: 03 Aug 2020 14:24 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17723
Comment Lines: 300
Empty Lines: 0
Non-Domain-only Rules Excluded: 10349
Domain-only Rules Excluded (unsupported options): 180
Domain-only Rules Excluded (exception conflict): 112
