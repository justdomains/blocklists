...
**Last Updated:** 2018-09-01 06:37:00
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15632 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 01 Sep 2018 06:01 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6058 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 01 Sep 2018 06:01 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 21177 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-08-31 14:18:54 |
...
- Title: EasyList
- Version: 201809010601
- Last Modified: 01 Sep 2018 06:01 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71517
Comment Lines: 391
Empty Lines: 0
Non-Domain-only Rules Excluded: 53321
Domain-only Rules Excluded (unsupported options): 1897
Domain-only Rules Excluded (exception conflict): 276
Domain-only Rules Output: 15632
```
...
Domain-only Rules Output: 21177
```
