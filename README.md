...
**Last Updated:** 2018-10-06 06:54:50
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16255 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 06 Oct 2018 04:35 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6083 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 06 Oct 2018 04:35 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 21881 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-10-05 14:21:07 |
...
- Title: EasyList
- Version: 201810060435
- Last Modified: 06 Oct 2018 04:35 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 72443
Comment Lines: 407
Empty Lines: 0
Non-Domain-only Rules Excluded: 53586
Domain-only Rules Excluded (unsupported options): 1927
Domain-only Rules Excluded (exception conflict): 268
Domain-only Rules Output: 16255
```
...
Domain-only Rules Output: 21881
```
