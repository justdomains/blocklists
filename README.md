...
**Last Updated:** 2019-03-04 08:11:51
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17931 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 04 Mar 2019 07:41 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6505 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 04 Mar 2019 07:41 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 26368 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-03-03 15:41:28 |
| [NoCoin Filter List](#nocoin-filter-list-domains-only) | [MIT](https://github.com/hoshsadiq/adblock-nocoin-list/blob/master/LICENSE) | 664 | [**Download**](https://justdomains.github.io/blocklists/lists/nocoin-justdomains.txt) | 13 February 2019 |
...
- Title: EasyList
- Version: 201903040741
- Last Modified: 04 Mar 2019 07:41 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75202
Comment Lines: 439
Empty Lines: 0
Non-Domain-only Rules Excluded: 54476
Domain-only Rules Excluded (unsupported options): 2085
Domain-only Rules Excluded (exception conflict): 271
Domain-only Rules Output: 17931
```
...
**Conversion Details:**
```
Total Lines Processed: 16477
Comment Lines: 190
Empty Lines: 0
Non-Domain-only Rules Excluded: 9481
Domain-only Rules Excluded (unsupported options): 145
Domain-only Rules Excluded (exception conflict): 156
Domain-only Rules Output: 6505
```
...
Domain-only Rules Output: 26368
```
