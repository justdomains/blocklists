...
**Last Updated:** 2018-07-18 06:15:27
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15178 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 18 Jul 2018 06:12 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 5927 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 17 Jul 2018 19:36 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardDNS/blob/master/LICENSE) | 20586 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-07-17 15:19:59 |
| [NoCoin Filter List](#nocoin-filter-list-domains-only) | [MIT](https://github.com/hoshsadiq/adblock-nocoin-list/blob/master/LICENSE) | 337 | [**Download**](https://justdomains.github.io/blocklists/lists/nocoin-justdomains.txt) | 10 July 2018 |
...
- Title: EasyList
- Version: 201807180612
- Last Modified: 18 Jul 2018 06:12 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 70917
Comment Lines: 387
Empty Lines: 0
Non-Domain-only Rules Excluded: 53198
Domain-only Rules Excluded (unsupported options): 1887
Domain-only Rules Excluded (exception conflict): 267
Domain-only Rules Output: 15178
```
...
- Title: EasyPrivacy
- Version: 201807171936
- Last Modified: 17 Jul 2018 19:36 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 15186
Comment Lines: 188
Empty Lines: 0
Non-Domain-only Rules Excluded: 8781
Domain-only Rules Excluded (unsupported options): 137
Domain-only Rules Excluded (exception conflict): 153
Domain-only Rules Output: 5927
```
