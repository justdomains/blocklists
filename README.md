...
**Last Updated:** 2020-08-28 14:56:17
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16510 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 28 Aug 2020 09:28 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6943 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 28 Aug 2020 09:28 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 35718 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-08-27T15:11:29.292Z |
...
- Title: EasyList
- Version: 202008280928
- Last Modified: 28 Aug 2020 09:28 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 63558
Comment Lines: 406
Empty Lines: 0
Non-Domain-only Rules Excluded: 44934
Domain-only Rules Excluded (unsupported options): 1645
Domain-only Rules Excluded (exception conflict): 63
Domain-only Rules Output: 16510
```
...
Domain-only Rules Output: 35718
```
