...
**Last Updated:** 2021-03-07 11:24:35
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16549 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 07 Mar 2021 11:23 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 10294 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 07 Mar 2021 11:20 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 38097 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2021-03-07T06:02:45.808Z |
...
- Title: EasyList
- Version: 202103071123
- Last Modified: 07 Mar 2021 11:23 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 58331
Comment Lines: 304
Empty Lines: 0
Non-Domain-only Rules Excluded: 39772
Domain-only Rules Excluded (unsupported options): 1633
Domain-only Rules Excluded (exception conflict): 73
...
- Title: EasyPrivacy
- Version: 202103071120
- Last Modified: 07 Mar 2021 11:20 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 21865
Comment Lines: 348
Empty Lines: 0
Non-Domain-only Rules Excluded: 10857
Domain-only Rules Excluded (unsupported options): 219
Domain-only Rules Excluded (exception conflict): 147
Domain-only Rules Output: 10294
```
