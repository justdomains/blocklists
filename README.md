...
**Last Updated:** 2019-05-31 09:01:31
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19220 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 31 May 2019 08:10 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6621 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 31 May 2019 08:10 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27700 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-05-30 16:24:21 |
...
- Title: EasyList
- Version: 201905310810
- Last Modified: 31 May 2019 08:10 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76662
Comment Lines: 447
Empty Lines: 0
Non-Domain-only Rules Excluded: 54465
Domain-only Rules Excluded (unsupported options): 2276
Domain-only Rules Excluded (exception conflict): 254
Domain-only Rules Output: 19220
```
...
**Conversion Details:**
```
Total Lines Processed: 16800
Comment Lines: 191
Empty Lines: 0
Non-Domain-only Rules Excluded: 9681
...
Domain-only Rules Output: 27700
```
