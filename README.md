...
**Last Updated:** 2019-12-24 10:44:23
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 22408 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 24 Dec 2019 10:36 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7283 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 24 Dec 2019 10:03 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 32247 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-12-23 18:03:06 |
...
- Title: EasyList
- Version: 201912241036
- Last Modified: 24 Dec 2019 10:36 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 72997
Comment Lines: 413
Empty Lines: 0
...
Domain-only Rules Output: 22408
```
...
- Title: EasyPrivacy
- Version: 201912241003
- Last Modified: 24 Dec 2019 10:03 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17398
Comment Lines: 212
Empty Lines: 0
Non-Domain-only Rules Excluded: 9667
Domain-only Rules Excluded (unsupported options): 149
Domain-only Rules Excluded (exception conflict): 87
Domain-only Rules Output: 7283
```
...
Domain-only Rules Output: 32247
```
