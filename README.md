...
**Last Updated:** 2019-09-08 09:52:31
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20960 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 08 Sep 2019 07:40 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6822 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 08 Sep 2019 07:40 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29881 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-09-07 17:09:06 |
...
- Title: EasyList
- Version: 201909080740
- Last Modified: 08 Sep 2019 07:40 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73859
Comment Lines: 418
Empty Lines: 0
Non-Domain-only Rules Excluded: 50105
Domain-only Rules Excluded (unsupported options): 2317
Domain-only Rules Excluded (exception conflict): 59
Domain-only Rules Output: 20960
```
...
Domain-only Rules Output: 29881
```
