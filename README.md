...
**Last Updated:** 2019-06-10 09:05:55
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19309 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 10 Jun 2019 08:44 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6625 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 10 Jun 2019 08:44 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27808 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-06-09 16:30:22 |
...
- Title: EasyList
- Version: 201906100844
- Last Modified: 10 Jun 2019 08:44 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75061
Comment Lines: 438
Empty Lines: 0
Non-Domain-only Rules Excluded: 52831
Domain-only Rules Excluded (unsupported options): 2258
Domain-only Rules Excluded (exception conflict): 225
Domain-only Rules Output: 19309
```
...
**Conversion Details:**
```
Total Lines Processed: 16808
Comment Lines: 191
Empty Lines: 0
Non-Domain-only Rules Excluded: 9684
Domain-only Rules Excluded (unsupported options): 148
Domain-only Rules Excluded (exception conflict): 160
...
Domain-only Rules Output: 27808
```
