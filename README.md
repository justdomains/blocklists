...
**Last Updated:** 2020-09-05 15:00:29
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16727 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 05 Sep 2020 13:22 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6953 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 05 Sep 2020 13:22 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 35835 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-09-04T15:16:17.074Z |
...
- Title: EasyList
- Version: 202009051322
- Last Modified: 05 Sep 2020 13:22 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 63218
Comment Lines: 385
Empty Lines: 0
Non-Domain-only Rules Excluded: 44449
Domain-only Rules Excluded (unsupported options): 1594
Domain-only Rules Excluded (exception conflict): 63
Domain-only Rules Output: 16727
```
...
Domain-only Rules Output: 35835
```
