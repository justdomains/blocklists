...
**Last Updated:** 2019-12-17 10:40:34
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 22352 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 17 Dec 2019 09:58 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7248 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 17 Dec 2019 09:58 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 32133 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-12-16 17:58:42 |
...
- Title: EasyList
- Version: 201912170958
- Last Modified: 17 Dec 2019 09:58 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73050
Comment Lines: 423
Empty Lines: 0
Non-Domain-only Rules Excluded: 47898
Domain-only Rules Excluded (unsupported options): 2318
Domain-only Rules Excluded (exception conflict): 59
Domain-only Rules Output: 22352
```
...
Domain-only Rules Output: 32133
```
