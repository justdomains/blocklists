...
**Last Updated:** 2019-08-05 09:34:54
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20387 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 05 Aug 2019 09:20 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6742 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 05 Aug 2019 09:20 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29250 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-04 16:54:53 |
...
- Title: EasyList
- Version: 201908050920
- Last Modified: 05 Aug 2019 09:20 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74566
Comment Lines: 433
Empty Lines: 0
Non-Domain-only Rules Excluded: 51312
Domain-only Rules Excluded (unsupported options): 2295
Domain-only Rules Excluded (exception conflict): 139
Domain-only Rules Output: 20387
```
...
Domain-only Rules Output: 29250
```
