...
**Last Updated:** 2019-05-16 08:53:05
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19085 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 16 May 2019 07:05 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6592 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 16 May 2019 07:06 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27591 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-05-15 16:19:23 |
...
- Title: EasyList
- Version: 201905160705
- Last Modified: 16 May 2019 07:05 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76787
Comment Lines: 444
Empty Lines: 0
Non-Domain-only Rules Excluded: 54745
Domain-only Rules Excluded (unsupported options): 2245
Domain-only Rules Excluded (exception conflict): 268
Domain-only Rules Output: 19085
```
...
- Title: EasyPrivacy
- Version: 201905160706
- Last Modified: 16 May 2019 07:06 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 16719
Comment Lines: 190
Empty Lines: 0
Non-Domain-only Rules Excluded: 9632
Domain-only Rules Excluded (unsupported options): 147
Domain-only Rules Excluded (exception conflict): 158
Domain-only Rules Output: 6592
```
...
Domain-only Rules Output: 27591
```
