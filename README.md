...
**Last Updated:** 2020-03-27 13:10:38
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16829 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 27 Mar 2020 12:28 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6656 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 27 Mar 2020 13:02 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 30001 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-03-26T19:52:25.666Z |
...
- Title: EasyList
- Version: 202003271228
- Last Modified: 27 Mar 2020 12:28 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67438
Comment Lines: 433
Empty Lines: 0
Non-Domain-only Rules Excluded: 48257
Domain-only Rules Excluded (unsupported options): 1857
Domain-only Rules Excluded (exception conflict): 62
Domain-only Rules Output: 16829
```
...
- Title: EasyPrivacy
- Version: 202003271302
- Last Modified: 27 Mar 2020 13:02 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17080
Comment Lines: 221
Empty Lines: 0
Non-Domain-only Rules Excluded: 9953
Domain-only Rules Excluded (unsupported options): 155
Domain-only Rules Excluded (exception conflict): 95
Domain-only Rules Output: 6656
```
