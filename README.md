...
**Last Updated:** 2019-05-24 08:57:39
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19166 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 24 May 2019 08:55 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6607 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 24 May 2019 08:55 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27656 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-05-23 16:21:58 |
...
- Title: EasyList
- Version: 201905240855
- Last Modified: 24 May 2019 08:55 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76887
Comment Lines: 447
Empty Lines: 0
Non-Domain-only Rules Excluded: 54751
Domain-only Rules Excluded (unsupported options): 2268
Domain-only Rules Excluded (exception conflict): 255
Domain-only Rules Output: 19166
```
...
Domain-only Rules Output: 27656
```
