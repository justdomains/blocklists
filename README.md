...
**Last Updated:** 2020-01-31 11:04:28
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15725 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 31 Jan 2020 10:26 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6494 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 31 Jan 2020 10:26 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27951 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-01-30 18:20:38 |
...
- Title: EasyList
- Version: 202001311026
- Last Modified: 31 Jan 2020 10:26 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 66016
Comment Lines: 419
Empty Lines: 0
Non-Domain-only Rules Excluded: 47944
Domain-only Rules Excluded (unsupported options): 1868
Domain-only Rules Excluded (exception conflict): 60
Domain-only Rules Output: 15725
```
...
**Conversion Details:**
```
Total Lines Processed: 16731
Comment Lines: 217
Empty Lines: 0
Non-Domain-only Rules Excluded: 9776
Domain-only Rules Excluded (unsupported options): 152
Domain-only Rules Excluded (exception conflict): 92
...
Domain-only Rules Output: 27951
```
