...
**Last Updated:** 2018-11-13 07:23:19
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16639 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 13 Nov 2018 03:30 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6239 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 13 Nov 2018 07:22 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 24770 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-11-12 14:45:10 |
...
- Title: EasyList
- Version: 201811130330
- Last Modified: 13 Nov 2018 03:30 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73110
Comment Lines: 411
Empty Lines: 0
Non-Domain-only Rules Excluded: 53845
Domain-only Rules Excluded (unsupported options): 1945
Domain-only Rules Excluded (exception conflict): 270
Domain-only Rules Output: 16639
```
...
- Title: EasyPrivacy
- Version: 201811130722
- Last Modified: 13 Nov 2018 07:22 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 15697
Comment Lines: 188
Empty Lines: 0
Non-Domain-only Rules Excluded: 8972
Domain-only Rules Excluded (unsupported options): 142
Domain-only Rules Excluded (exception conflict): 156
Domain-only Rules Output: 6239
```
...
Domain-only Rules Output: 24770
```
