...
**Last Updated:** 2019-03-20 08:22:06
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 18092 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 20 Mar 2019 07:28 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6517 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 20 Mar 2019 07:28 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 26555 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-03-19 15:50:12 |
...
- Title: EasyList
- Version: 201903200728
- Last Modified: 20 Mar 2019 07:28 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 75443
Comment Lines: 438
Empty Lines: 0
Non-Domain-only Rules Excluded: 54556
Domain-only Rules Excluded (unsupported options): 2087
Domain-only Rules Excluded (exception conflict): 270
Domain-only Rules Output: 18092
```
...
Domain-only Rules Output: 26555
```
