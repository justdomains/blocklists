...
**Last Updated:** 2019-09-06 09:52:34
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20902 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 06 Sep 2019 08:59 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6804 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 06 Sep 2019 08:59 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29832 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-09-05 17:08:10 |
...
- Title: EasyList
- Version: 201909060859
- Last Modified: 06 Sep 2019 08:59 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73782
Comment Lines: 417
Empty Lines: 0
Non-Domain-only Rules Excluded: 50090
Domain-only Rules Excluded (unsupported options): 2315
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 20902
```
...
Domain-only Rules Output: 29832
```
