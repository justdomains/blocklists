...
**Last Updated:** 2019-02-12 08:03:35
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17484 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 10 Feb 2019 23:54 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6490 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 10 Feb 2019 23:54 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 25847 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-02-11 15:30:45 |
...
- Title: EasyList
- Version: 201902102354
- Last Modified: 10 Feb 2019 23:54 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74728
Comment Lines: 439
Empty Lines: 0
Non-Domain-only Rules Excluded: 54476
Domain-only Rules Excluded (unsupported options): 2057
Domain-only Rules Excluded (exception conflict): 272
Domain-only Rules Output: 17484
```
...
**Conversion Details:**
```
Total Lines Processed: 16431
Comment Lines: 190
Empty Lines: 0
Non-Domain-only Rules Excluded: 9450
...
Domain-only Rules Output: 25847
```
