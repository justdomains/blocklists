...
**Last Updated:** 2019-05-23 08:57:20
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19165 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 23 May 2019 07:59 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6607 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 23 May 2019 07:59 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27647 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-05-22 16:21:50 |
...
- Title: EasyList
- Version: 201905230759
- Last Modified: 23 May 2019 07:59 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76882
Comment Lines: 447
Empty Lines: 0
Non-Domain-only Rules Excluded: 54747
Domain-only Rules Excluded (unsupported options): 2268
Domain-only Rules Excluded (exception conflict): 255
Domain-only Rules Output: 19165
```
...
Domain-only Rules Output: 27647
```
