...
**Last Updated:** 2020-05-27 13:58:49
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17889 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 27 May 2020 13:11 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6695 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 27 May 2020 13:11 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 36704 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-05-26T17:00:59.234Z |
...
- Title: EasyList
- Version: 202005271311
- Last Modified: 27 May 2020 13:11 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 68767
Comment Lines: 442
Empty Lines: 0
Non-Domain-only Rules Excluded: 48508
Domain-only Rules Excluded (unsupported options): 1864
...
**Conversion Details:**
```
Total Lines Processed: 17310
Comment Lines: 225
Empty Lines: 0
Non-Domain-only Rules Excluded: 10121
Domain-only Rules Excluded (unsupported options): 167
Domain-only Rules Excluded (exception conflict): 102
Domain-only Rules Output: 6695
```
