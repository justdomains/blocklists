...
**Last Updated:** 2019-02-08 08:00:04
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17456 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 08 Feb 2019 07:31 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6490 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 08 Feb 2019 07:31 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 25809 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-02-07 15:38:49 |
| [NoCoin Filter List](#nocoin-filter-list-domains-only) | [MIT](https://github.com/hoshsadiq/adblock-nocoin-list/blob/master/LICENSE) | 681 | [**Download**](https://justdomains.github.io/blocklists/lists/nocoin-justdomains.txt) | 05 February 2019 |
...
- Title: EasyList
- Version: 201902080731
- Last Modified: 08 Feb 2019 07:31 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74811
Comment Lines: 442
Empty Lines: 0
Non-Domain-only Rules Excluded: 54582
Domain-only Rules Excluded (unsupported options): 2058
Domain-only Rules Excluded (exception conflict): 273
Domain-only Rules Output: 17456
```
...
**Conversion Details:**
```
Total Lines Processed: 16423
Comment Lines: 190
Empty Lines: 0
Non-Domain-only Rules Excluded: 9440
Domain-only Rules Excluded (unsupported options): 145
Domain-only Rules Excluded (exception conflict): 158
...
Domain-only Rules Output: 25809
```
