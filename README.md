...
**Last Updated:** 2019-09-11 09:54:05
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 21023 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 11 Sep 2019 06:50 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6826 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 11 Sep 2019 06:51 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29976 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-09-11 08:44:16 |
...
- Title: EasyList
- Version: 201909110650
- Last Modified: 11 Sep 2019 06:50 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73928
Comment Lines: 418
Empty Lines: 0
Non-Domain-only Rules Excluded: 50113
Domain-only Rules Excluded (unsupported options): 2316
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 21023
```
...
- Title: EasyPrivacy
- Version: 201909110651
- Last Modified: 11 Sep 2019 06:51 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17281
Comment Lines: 200
Empty Lines: 0
Non-Domain-only Rules Excluded: 9937
Domain-only Rules Excluded (unsupported options): 151
Domain-only Rules Excluded (exception conflict): 167
Domain-only Rules Output: 6826
```
