...
**Last Updated:** 2018-08-01 06:21:43
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15388 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 01 Aug 2018 06:09 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 5969 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 01 Aug 2018 06:09 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardDNS/blob/master/LICENSE) | 20852 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-07-31 15:28:48 |
...
- Title: EasyList
- Version: 201808010609
- Last Modified: 01 Aug 2018 06:09 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71235
Comment Lines: 390
Empty Lines: 0
Non-Domain-only Rules Excluded: 53300
Domain-only Rules Excluded (unsupported options): 1889
Domain-only Rules Excluded (exception conflict): 268
Domain-only Rules Output: 15388
```
...
Domain-only Rules Output: 20852
```
