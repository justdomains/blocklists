...
**Last Updated:** 2019-08-04 09:34:19
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20378 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 04 Aug 2019 08:34 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6742 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 04 Aug 2019 08:34 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29245 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-03 16:54:32 |
...
- Title: EasyList
- Version: 201908040834
- Last Modified: 04 Aug 2019 08:34 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74764
Comment Lines: 433
Empty Lines: 0
Non-Domain-only Rules Excluded: 51512
Domain-only Rules Excluded (unsupported options): 2295
Domain-only Rules Excluded (exception conflict): 146
Domain-only Rules Output: 20378
```
...
**Conversion Details:**
```
Total Lines Processed: 17076
Comment Lines: 195
Empty Lines: 0
Non-Domain-only Rules Excluded: 9822
...
Domain-only Rules Output: 29245
```
