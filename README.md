...
**Last Updated:** 2020-04-26 13:38:29
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17548 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 26 Apr 2020 11:52 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6752 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 26 Apr 2020 11:52 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 36066 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-04-25T14:07:01.630Z |
...
- Title: EasyList
- Version: 202004261152
- Last Modified: 26 Apr 2020 11:52 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 68209
Comment Lines: 436
Empty Lines: 0
Non-Domain-only Rules Excluded: 48309
Domain-only Rules Excluded (unsupported options): 1855
Domain-only Rules Excluded (exception conflict): 61
Domain-only Rules Output: 17548
```
...
**Conversion Details:**
```
Total Lines Processed: 17316
Comment Lines: 223
Empty Lines: 0
Non-Domain-only Rules Excluded: 10074
Domain-only Rules Excluded (unsupported options): 168
Domain-only Rules Excluded (exception conflict): 99
Domain-only Rules Output: 6752
```
...
Domain-only Rules Output: 36066
```
