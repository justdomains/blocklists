...
**Last Updated:** 2020-03-20 11:29:02
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16678 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 20 Mar 2020 11:18 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6652 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 20 Mar 2020 11:18 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29820 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-03-19T18:45:04.645Z |
...
- Title: EasyList
- Version: 202003201118
- Last Modified: 20 Mar 2020 11:18 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 67268
Comment Lines: 437
Empty Lines: 0
Non-Domain-only Rules Excluded: 48240
Domain-only Rules Excluded (unsupported options): 1851
Domain-only Rules Excluded (exception conflict): 62
Domain-only Rules Output: 16678
```
...
**Conversion Details:**
```
Total Lines Processed: 17070
Comment Lines: 222
Empty Lines: 0
Non-Domain-only Rules Excluded: 9947
Domain-only Rules Excluded (unsupported options): 155
Domain-only Rules Excluded (exception conflict): 94
Domain-only Rules Output: 6652
```
...
Domain-only Rules Output: 29820
```
