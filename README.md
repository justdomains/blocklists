...
**Last Updated:** 2018-09-22 06:47:22
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16005 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 22 Sep 2018 05:27 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6075 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 22 Sep 2018 05:27 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 21605 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-09-21 14:15:21 |
...
- Title: EasyList
- Version: 201809220527
- Last Modified: 22 Sep 2018 05:27 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71416
Comment Lines: 395
Empty Lines: 0
Non-Domain-only Rules Excluded: 52851
Domain-only Rules Excluded (unsupported options): 1904
Domain-only Rules Excluded (exception conflict): 261
Domain-only Rules Output: 16005
```
...
Domain-only Rules Output: 21605
```
