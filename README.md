...
**Last Updated:** 2019-10-27 10:16:27
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 21497 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 27 Oct 2019 09:24 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6963 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 27 Oct 2019 09:24 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 30790 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-10-26 17:32:16 |
...
- Title: EasyList
- Version: 201910270924
- Last Modified: 27 Oct 2019 09:24 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 74425
Comment Lines: 423
Empty Lines: 0
Non-Domain-only Rules Excluded: 50155
Domain-only Rules Excluded (unsupported options): 2292
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 21497
```
...
**Conversion Details:**
```
Total Lines Processed: 17592
Comment Lines: 208
Empty Lines: 0
Non-Domain-only Rules Excluded: 10109
Domain-only Rules Excluded (unsupported options): 143
...
Domain-only Rules Output: 30790
```
