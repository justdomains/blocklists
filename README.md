...
**Last Updated:** 2019-08-15 09:39:48
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20570 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 15 Aug 2019 09:20 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6761 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 15 Aug 2019 09:38 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 29403 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-08-14 16:59:44 |
...
- Title: EasyList
- Version: 201908150920
- Last Modified: 15 Aug 2019 09:20 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 73583
Comment Lines: 415
Empty Lines: 0
Non-Domain-only Rules Excluded: 50236
Domain-only Rules Excluded (unsupported options): 2306
Domain-only Rules Excluded (exception conflict): 56
Domain-only Rules Output: 20570
```
...
- Title: EasyPrivacy
- Version: 201908150938
- Last Modified: 15 Aug 2019 09:38 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17128
Comment Lines: 197
Empty Lines: 0
Non-Domain-only Rules Excluded: 9851
Domain-only Rules Excluded (unsupported options): 151
Domain-only Rules Excluded (exception conflict): 168
Domain-only Rules Output: 6761
```
...
Domain-only Rules Output: 29403
```
