...
**Last Updated:** 2021-03-17 11:25:09
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16657 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 17 Mar 2021 11:05 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 11087 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 17 Mar 2021 11:05 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 37377 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2021-03-17T06:03:01.268Z |
...
- Title: EasyList
- Version: 202103171105
- Last Modified: 17 Mar 2021 11:05 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 58553
Comment Lines: 306
Empty Lines: 0
Non-Domain-only Rules Excluded: 39872
Domain-only Rules Excluded (unsupported options): 1646
Domain-only Rules Excluded (exception conflict): 72
Domain-only Rules Output: 16657
```
...
**Conversion Details:**
```
Total Lines Processed: 22462
Comment Lines: 366
Empty Lines: 0
Non-Domain-only Rules Excluded: 10666
Domain-only Rules Excluded (unsupported options): 216
Domain-only Rules Excluded (exception conflict): 127
Domain-only Rules Output: 11087
```
...
Domain-only Rules Output: 37377
```
