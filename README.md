...
**Last Updated:** 2019-05-25 08:58:28
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 19179 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 25 May 2019 08:31 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6616 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 25 May 2019 08:31 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27660 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2019-05-24 16:22:58 |
...
- Title: EasyList
- Version: 201905250831
- Last Modified: 25 May 2019 08:31 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 76931
Comment Lines: 447
Empty Lines: 0
Non-Domain-only Rules Excluded: 54775
Domain-only Rules Excluded (unsupported options): 2275
Domain-only Rules Excluded (exception conflict): 255
Domain-only Rules Output: 19179
```
...
Domain-only Rules Output: 27660
```
