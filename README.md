...
**Last Updated:** 2020-01-04 10:50:36
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 20971 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 04 Jan 2020 09:41 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 7325 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 04 Jan 2020 10:47 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 31472 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-01-03 18:08:39 |
...
- Title: EasyList
- Version: 202001040941
- Last Modified: 04 Jan 2020 09:41 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 71462
Comment Lines: 412
Empty Lines: 0
Non-Domain-only Rules Excluded: 47849
Domain-only Rules Excluded (unsupported options): 2172
Domain-only Rules Excluded (exception conflict): 58
Domain-only Rules Output: 20971
```
...
- Title: EasyPrivacy
- Version: 202001041047
- Last Modified: 04 Jan 2020 10:47 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 17532
Comment Lines: 213
Empty Lines: 0
Non-Domain-only Rules Excluded: 9754
Domain-only Rules Excluded (unsupported options): 152
Domain-only Rules Excluded (exception conflict): 88
Domain-only Rules Output: 7325
```
