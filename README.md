...
**Last Updated:** 2020-02-09 11:10:30
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 15474 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 09 Feb 2020 09:37 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6550 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 09 Feb 2020 09:37 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 27976 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-02-08 18:25:37 |
...
- Title: EasyList
- Version: 202002090937
- Last Modified: 09 Feb 2020 09:37 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 65787
Comment Lines: 423
Empty Lines: 0
Non-Domain-only Rules Excluded: 47990
Domain-only Rules Excluded (unsupported options): 1841
Domain-only Rules Excluded (exception conflict): 59
Domain-only Rules Output: 15474
```
...
Domain-only Rules Output: 27976
```
