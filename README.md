...
**Last Updated:** 2020-07-20 14:30:40
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17512 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 20 Jul 2020 13:19 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6830 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 20 Jul 2020 13:19 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 36195 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2020-07-19T14:55:18.875Z |
...
- Title: EasyList
- Version: 202007201319
- Last Modified: 20 Jul 2020 13:19 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 68591
Comment Lines: 446
Empty Lines: 0
Non-Domain-only Rules Excluded: 48738
Domain-only Rules Excluded (unsupported options): 1830
Domain-only Rules Excluded (exception conflict): 65
Domain-only Rules Output: 17512
```
...
- Version: 2.0.10.61
- Last Modified: 2020-07-19T14:55:18.875Z
...
Domain-only Rules Output: 36195
```
