...
**Last Updated:** 2021-11-29 11:12:36
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 17704 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 29 Nov 2021 10:59 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16903 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 29 Nov 2021 10:59 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 42147 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2021-11-29T06:06:40.040Z |
...
- Title: EasyList
- Version: 202111291059
- Last Modified: 29 Nov 2021 10:59 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 56432
Comment Lines: 221
Empty Lines: 0
Non-Domain-only Rules Excluded: 36647
Domain-only Rules Excluded (unsupported options): 1812
Domain-only Rules Excluded (exception conflict): 48
Domain-only Rules Output: 17704
```
...
Domain-only Rules Output: 42147
```
