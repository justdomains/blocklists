...
**Last Updated:** 2018-10-30 07:08:57
...
:- | - | - | :-: | - |
| [EasyList](#easylist-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 16498 | [**Download**](https://justdomains.github.io/blocklists/lists/easylist-justdomains.txt) | 30 Oct 2018 07:04 UTC |
| [EasyPrivacy](#easyprivacy-domains-only) | [GPL3 / CC BY-SA 3.0](https://easylist.to/pages/licence.html) | 6206 | [**Download**](https://justdomains.github.io/blocklists/lists/easyprivacy-justdomains.txt) | 30 Oct 2018 07:04 UTC |
| [AdGuard Simplified Domain Names Filter](#adguard-simplified-domain-names-filter-domains-only) | [GPL3](https://github.com/AdguardTeam/AdguardSDNSFilter/blob/master/LICENSE) | 24385 | [**Download**](https://justdomains.github.io/blocklists/lists/adguarddns-justdomains.txt) | 2018-10-29 14:36:19 |
...
- Title: EasyList
- Version: 201810300704
- Last Modified: 30 Oct 2018 07:04 UTC
- Homepage: [https://easylist.to/](https://easylist.to/)

**Conversion Details:**
```
Total Lines Processed: 72903
Comment Lines: 408
Empty Lines: 0
Non-Domain-only Rules Excluded: 53789
Domain-only Rules Excluded (unsupported options): 1939
Domain-only Rules Excluded (exception conflict): 269
Domain-only Rules Output: 16498
```
...
Domain-only Rules Output: 24385
```
